...
from graphnet.models.graphs.edges import KNNEdges, RadialEdges
...
class RadialGraph(GraphDefinition):
    """A Graph representation where Edges are drawn according to a radius."""
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        """Construct radial graph representation.
        ...
        Args:
            ...
            seed: seed or Generator used to randomly sample perturbations.
                  Defaults to None.
            radius: radius fed to edge definition
            columns: node feature columns used for distance calculation
            . Defaults to [0, 1, 2].
        """
        # Base class constructor
